...
def main():
    ...
    parser.add_argument('--pascal_im_list',default='../utils/pascal_val.txt',help='file containing names of image-files')
    parser.add_argument('--pascal_im_loc',help='location for the pascal VOC 2012 folder')
    args = parser.parse_args()
    
    validate_arguments(args)
    save_preprocessed(args.network, args.save_loc,args.pascal_im_list,args.pascal_im_loc)
