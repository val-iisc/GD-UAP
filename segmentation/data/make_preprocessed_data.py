...
def save_preprocessed(net, save_loc, im_list):
    ...
    if os.path.isfile(save_name):
        ...
        for i in range(1000):
            ...
            ratio = 2
            img_temp = cv2.resize(img_temp, (int(
                img_temp.shape[1]*ratio), int(img_temp.shape[0]*ratio))).astype(float)
...
def main():
    ...
    parser.add_argument('--network', default='fcn_alexnet',
    ...
    parser.add_argument('--ilsvrc_im_list', default='../utils/ilsvrc_val.txt',
