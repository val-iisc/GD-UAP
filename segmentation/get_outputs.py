...
def evaluate(model,size,net_name,im_path,im_list,save_path,adv_im):
    ...
    for iter, chunk in enumerate(chunker(file_list, batch_size)):
        ...
        sio.imsave(os.path.join(args.save_path,'perturbed_predidction/',file_list[iter]+'.png'),pert_out)
        if(iter%50 == 0):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--im_list', default='utils/pascal_val_id.txt', help='The file with list of Pascal VOC file IDs.')
    ...
    parser.add_argument('--adv_im', default='perturbations/dl_vgg16_with_data.npy', help='The UAP generated by GD-UAP to test on the given network.')
