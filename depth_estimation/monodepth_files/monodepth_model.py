...
class MonodepthModel(object):
    ...
    def __init__(self, params, mode, left, right, input_tf,reuse_variables=None, model_index=0):
        self.params = params
        self.mode = mode
        #noise = tf.random_uniform([2,256,512,3],minval=-10.0/128. ,maxval=10.0/128.)
        self.left = input_tf#+noise#left
        self.right = right
        ...
        with slim.arg_scope([slim.conv2d, slim.conv2d_transpose], activation_fn=tf.nn.elu):
            with tf.variable_scope('model', reuse=self.reuse_variables):
                ...
                if self.params.do_stereo:
                    ...
                    #input_tf = tf.placeholder(shape = [2,256,512,3],dtype='float32', name = 'input_image')
