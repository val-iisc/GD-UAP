...
parser.add_argument('--prev_pred',             type=str,   help='path to ground truth disparities',   required=True)
...
if __name__ == '__main__':
    ...
    if args.split == 'kitti':
        ...
        for t_id in range(num_samples):
            ...
            disp_pred = cv2.resize(prev_disparities[t_id], (im_sizes[t_id][1], im_sizes[t_id][0]), interpolation=cv2.INTER_LINEAR)
